...
make bandwidth_emulator gesummv_smi_emulator kmeans_smi_emulator stencil_smi_emulator scatter_emulator broadcast_emulator reduce_emulator bandwidth_emulator gather_emulator bandwidth_eager_emulator multi_collectives_emulator -j41 #stencil_onchip_emulator
